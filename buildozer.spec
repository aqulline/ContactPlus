...
source.include_exts = py,png,jpg,kv,atlas,json, txt, svg, otf
...
presplash.filename = components/pres.png

# (str) Icon of the application
icon.filename = components/icon_contact.png
...
android.permissions = INTERNET, WRITE_EXTERNAL_STORAGE, ACCESS_MEDIA_LOCATION, READ_EXTERNAL_STORAGE,ACCESS_WIFI_STATE,ACCESS_NETWORK_STATE, CALL_PHONE, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION, CALL_PRIVILEGED, WRITE_CONTACTS, READ_CONTACTS, POST_NOTIFICATIONS
...
android.gradle_dependencies =com.facebook.android:facebook-login:8.1.0, com.google.android.gms:play-services-auth:18.0.0, com.google.firebase:firebase-auth:19.3.1
...
android.meta_data = com.facebook.sdk.ApplicationId=fb439926446854840
